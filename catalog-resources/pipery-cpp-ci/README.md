# Pipery C++ CI Component

Reusable GitLab CI/CD component for complete C++ CI pipeline with structured logging.

## Overview

This component provides a complete CI/CD pipeline for C++ projects:
- SAST scanning
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-cpp-ci/catalog-resources/pipery-cpp-ci@main
...
| CPP_VERSION | 11 | C++ runtime version |
